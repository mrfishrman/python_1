...
if __name__ == '__main__':
    ...
    while True:
            ...
            print(f'Aceleración (m/s^2): X={accel_data[0]:.2f}, Y={accel_data[1]:.2f}, Z={accel_data[2]:.2f}')
            print(f'Giroscopio (grados/s): X={gyro_data[0]:.2f}, Y={gyro_data[1]:.2f}, Z={gyro_data[2]:.2f}')
